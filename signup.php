	...
	<div class="col-md-12">
		...
		<div class="col-md-6 well well-sm">
			<form method="post" class="form-group">
				...
				<input type="text" class="form-control" name="phone" placeholder="Phone Number" required="yes">
				<br>
...
if($email==$results){
	...
	if($password==$confpassword){
 	$sql = "INSERT INTO users (email, username, password, phone_number) VALUES ('$email','$username','$password','$phone')";
