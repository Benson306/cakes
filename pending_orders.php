...
<div class="col-md-12">
	...
	<div class="col-md-10">
	<center>
		<h3 class="well well-sm">ORDERS PENDING DELIVERY</h3>
	</center>
	 ...
	 $run = mysqli_query($conn, $sql);
		 ...
		 while($rows = mysqli_fetch_assoc($run) ) {
		 	echo "
	 			...
	 			<th><a href='pending_orders.php?del_id=$rows[order_id]' class='btn btn-danger'>Cancel Order</button></a></th>
	 			<th><a href='mark_delivery.php?deliver_id=$rows[order_id]' class='btn btn-success'>Mark As Delivered</button></a></th>
		 		</tr>
		 	";
		 $num++;
		 }
